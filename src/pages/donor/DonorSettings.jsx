...
import { User, ShieldCheck, MapPin, Save, Lock } from 'lucide-react';
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-xs text-slate-500">
          Manage your personal profile, pickup preferences, and security settings.
        </p>
      </div>
          ...
          {activeTab === 'handover' && (
            <form onSubmit={handleProfileSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-xs font-bold text-slate-700 mb-1">Pickup Address / Neighborhood</label>
                  <input
                    type="text"
              ...
              <div>
                <label className="block text-xs font-bold text-slate-700 mb-1">
                  Handover Radius: {profileForm.pickup_radius} miles
                </label>
                <input
                  type="range"
                  min="2"
                ...
                />
                <span className="text-[11px] text-slate-400">Items within this geographic distance will be prioritized for matching.</span>
              </div>
              ...
              <div className="pt-2 flex justify-end">
                ...
                >
                  <Save className="w-3.5 h-3.5" />
                  <span>Save Handover Settings</span>
                </button>
              </div>
            </form>
          )}
